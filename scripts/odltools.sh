...
python -m odltools show cluster-info --ip $odl_ip --port $port --user $username --pw $password >> ~/odltools/cluster.info
python -m odltools analyze tunnels --ip $odl_ip --port $port --user $username --pw $password --path ~/odltools/tunnels >> ~/odltools/tunnels_info.log
python -m odltools show eos --ip $odl_ip --port $port --user $username --pw $password --path ~/odltools/eos 
