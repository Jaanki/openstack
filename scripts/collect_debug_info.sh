...
source ~/stackrc
nova list >> ~/debug_info/undercloud.log
source ~/overcloudrc
nova list >> ~/debug_info/overcloud.log
neutron net-list >> ~/debug_info/overcloud.log
neutron port-list >> ~/debug_info/overcloud.log
neutron router-list >> ~/debug_info/overcloud.log
